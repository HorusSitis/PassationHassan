# -*- coding: utf-8 -*-
"""
Created on Tue Jul 10 17:18:52 2018
...
repertoire_read="Solutions_homog_interp_circulaire/"
...
#      print u(0,0.5),u(1,0.5),u(0.5,0),u(0.5,1)
...
#    ui.vector().set_local(phi[:,i])
#    scal=assemble(dot(ui,ui)*dx)
#    phi[:,i]=phi[:,i]/sqrt(scal)
...
# Calcul d'erreur suivant le nb de modes
modes=np.arange(1,nb_modes+1,1)
erreur=erreur_nbmode_inst(V_fixe,Usnap,nb_modes,R_dim,nb_noeuds,A,phi)
plt.plot(modes,erreur)
...
repertoire_final_1="Homog_base_maill_init_circulaire/"

File("Homog_base_maill_init_circulaire/mesh_circulaire.xml.gz") << mesh
...
repertoire_final_2="Solution_homog_red_maill_init_circulaire/"
