...
\subsubsection{Refining mesh resolution : a single spherical inclusion}
...
$\rho^{new}$&Porosity&${D_k^{hom,ROM}}_{11}$&${D_k^{hom,FEM}}_{11}$&Meshing&$Err$&$\phi_i^{new}$&ROM&FEM&Nodes\\
\hline
0,11&0,&0,&0,&2,28s&0,\%&s&s&s&136002\\
\hline
0,22&0,&0,&0,&1,83s&0,\%&s&s&s&126192\\
\hline
0,33&0,&0,&0,&1,95s&0,\%&s&s&s&120318\\
\hline
0,44&0,&0,&0,&1,95s&0,\%&s&s&s&96503\\
\hline
\end{tabular}
\end{center}
\caption{$N_{rom}=4$}
