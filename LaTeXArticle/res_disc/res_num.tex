...
\rowcolor{lightgray} $\rho^{new}$&Porosity&${D_k^{hom,ROM}}_{11}$&${D_k^{hom,FEM}}_{11}$&Meshing&$Err$&$\phi_i^{new}$&ROM&FEM&Nodes\\
\hline
0,11&0,96199&0,92874&0,92770&2.24s&0,1116\%&64.54s&2.08s&98.26s&132\ 963\\
\hline
0,22&0,84795&0,73657&0,73661&1.68s&0,0056\%&55.03s&1.90s&17.24s&114\ 534\\
\hline
0,33&0,65789&0,48873&0,48874&1.60s&0,0029\%&44.49s&1.77s&13.06s&97\ 029\\
\hline
0,44&0,39179&0,22272&0,22260&1.38s&0,0523\%&30.02s&1.52s&8.35s&69\ 612\\
\hline
\end{tabular}
\end{center}
...
\rowcolor{lightgray} $\rho^{new}$&Porosity&${D_k^{hom,ROM}}_{11}$&${D_k^{hom,FEM}}_{11}$&Meshing&$Err$&$\phi_i^{new}$&ROM&FEM&Nodes\\
\hline
0,11&0,98029&0,97370&0,97367&2.36s&0,0024\%&42.12s&1.51s&21.12s&143\ 322\\
\hline
0,22&0,94126&0,93500&0,93503&1.88s&0,0033\%&39.15s&1.43s&20.55s&134\ 229\\
\hline
0,33&0,83533&0,83002&0,83009&1.94s&0,0093\%&35.29s&2.00s&16.95s&125\ 094\\
\hline
0,44&0,62904&0,62589&0,62591&1.95s&0,0036\%&27.30s&1.80s&15.29s&100\ 767\\
\hline
\end{tabular}
\end{center}
...
\rowcolor{lightgray} $\rho^{new}$&Porosity&${D_k^{hom,ROM}}_{11}$&${D_k^{hom,FEM}}_{11}$&Meshing&$Err$&$\phi_i^{new}$&ROM&FEM&Nodes\\
\hline
0,11&0,98029&0,&0,&2.28s&0,\%&s&s&s&\\
\hline
0,22&0,94126&0,&0,&1.79s&0,\%&s&s&s&\\
\hline
...
\rowcolor{lightgray} $\rho^{new}$&Porosity&${D_k^{hom,ROM}}_{11}$&${D_k^{hom,FEM}}_{11}$&Meshing&$Err$&$\phi_i^{new}$&ROM&FEM&Nodes\\
\hline
0,11&0,&0,&0,&2.78s&0,\%&s&s&s&\\
\hline
0,22&0,&0,&0,&1.74s&0,\%&s&s&s&\\
\hline
0,33&0,&0,&0,&1.58s&0,\%&s&s&s&\\
\hline
0,44&0,&0,&0,&1.35s&0,\%&s&s&s&\\
\hline
\end{tabular}
\end{center}
\caption{Resolution : $20$\ ; $N_{rom}=4$}
...
\rowcolor{lightgray} $\rho^{new}$&Porosity&${D_k^{hom,ROM}}_{11}$&${D_k^{hom,FEM}}_{11}$&Meshing&$Err$&$\phi_i^{new}$&ROM&FEM&Nodes\\
\hline
0,11&0,&0,&0,&19.78s&0,\%&s&s&s&\\
\hline
0,22&0,&0,&0,&18.08s&0,\%&s&s&s&\\
\hline
0,33&0,&0,&0,&14.16s&0,\%&s&s&s&\\
\hline
0,44&0,&0,&0,&9.86s&0,\%&s&s&s&\\
\hline
\end{tabular}
\end{center}
