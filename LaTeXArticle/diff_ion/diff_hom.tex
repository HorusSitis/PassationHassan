...
\hline
$0.35$&$0.6151549$&10${}^{''}$&$\left(\begin{array}{cc}0.630227160266 & 2.46470607 \cdot 10^{-11}\\2.46462659 \cdot 10^{-11}& 0.630227110\end{array}\right)$&\\
\hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|}
\hline
\subfloat[Mesh around the inclusion]{\includegraphics[width=0.24\linewidth,height=3.2cm]{../Figures3D/maillageCyrille_facettes.png}}
&%\hfill
...
Radius :&Porosity :&Time elapsed : 1CPU$\times$2.9GHz&$D_k^{hom}$ :&Mesh resolution:\\
\hline
$0.35$&$0.8204$&35${}^{''}$&0.799883932&\\%$\left(\begin{array}{ccc}0.799883932 & 2.46470607 \cdot 10^{-11}&\\2.46462659 \cdot 10^{-11}& 0.630227110&\\&&\end{array}\right)$&\\
\hline
\end{tabular}
