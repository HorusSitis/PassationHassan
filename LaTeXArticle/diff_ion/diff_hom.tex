...
\\
\hline
\subfloat[Vector $\chi(\mathbf{y},\rho)$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/sol_5_sur8cer_un_ray.png}}
&
\subfloat[Vector $\chi(\mathbf{y},\rho)$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/sol_5_sur8cer_un_som_ray.png}}
&
\subfloat[Vector $\chi(\mathbf{y},\rho)$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/sol_5_sur8compl_diag.png}}
&
\subfloat[Vector $\chi(\mathbf{y},\rho)$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/sol_5_sur8compl_hor.png}}
\\
\hline
\end{tabular}
\end{center}
