...
\begin{tabular}{|c|c|c|c|}
\hline
\subfloat[Centered inclusion]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/maillage_gmsh_per_cer_unray_ray25.png}}
&
\subfloat[Disc at vertices]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/maillage_gmsh_per_cer_un_somray_ray25.png}}
&
\subfloat[Diagonal alignement]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/maillage_gmsh_per_compldiag_ray25.png}}
&
\subfloat[Horizontal alignement]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/maillage_gmsh_per_complhor_ray25.png}}
\\
\hline
\subfloat[Vector $\chi(\mathbf{y},\rho)$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/sol_5_sur1cer_un_ray.png}}
&
\subfloat[Vector $\chi(\mathbf{y},\rho)$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/sol_5_sur1cer_un_som_ray.png}}
&
\subfloat[Vector $\chi(\mathbf{y},\rho)$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/sol_5_sur1compl_diag.png}}
&
\subfloat[Vector $\chi(\mathbf{y},\rho)$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures2D/sol_6_sur1compl_hor.png}}
\\
\hline
\end{tabular}
\end{center}
...
\hline
%%Centered inclusion&$0.6151549$&15,84${}^{''}$&$\left(\begin{array}{cc}0.630227160266 & 2.46470607 \cdot 10^{-11}\\2.46462659 \cdot 10^{-11}& 0.630227110\end{array}\right)$&85658 \\
...
\begin{tabular}{|c|c|c|c|}
\hline
\subfloat[Mesh for a single sphere]{\includegraphics[width=0.2\linewidth,height=3cm]{../Figures3D/maillage_per3D_sph.png}}
&
\subfloat[Single cylinder]{\includegraphics[width=0.2\linewidth,height=3cm]{../Figures3D/maillage_per3D_cyl.png}}
&
\subfloat[Two spheres]{\includegraphics[width=0.2\linewidth,height=3cm]{../Figures3D/maillage_per3D_2sph.png}}
&
\subfloat[One sphere and one cylinder]{\includegraphics[width=0.2\linewidth,height=3cm]{../Figures3D/maillage_per3D_cylsph.png}}
\\
\hline
\subfloat[Vector $\chi$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures3D/sol_7_sur1sph_un_rayres10.png}}
&
\subfloat[Vector $\chi$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures3D/sol_7_sur1cyl_un_rayres10.png}}
&
\subfloat[Vector $\chi$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures3D/sol_7_sur12sph_rayres10.png}}
&
\subfloat[Vector $\chi$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures3D/sol_7_sur1cylsph_ray_sphres10.png}}
\\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{|c|c|c|c|}
\hline
\subfloat[Mesh for a single sphere]{\includegraphics[width=0.2\linewidth,height=3cm]{../Figures3D/maillage_per3D_sphsur20.png}}
&
\subfloat[Single cylinder]{\includegraphics[width=0.2\linewidth,height=3cm]{../Figures3D/maillage_per3D_cylsur20.png}}
&
\subfloat[Two spheres]{\includegraphics[width=0.2\linewidth,height=3cm]{../Figures3D/maillage_per3D_2sphsur20.png}}
&
\subfloat[One sphere and one cylinder]{\includegraphics[width=0.2\linewidth,height=3cm]{../Figures3D/maillage_per3D_cylsphsur20.png}}
\\
\hline
\subfloat[Vector $\chi$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures3D/sol_7_sur1sph_un_rayres20.png}}
&
\subfloat[Vector $\chi$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures3D/sol_7_sur1cyl_un_rayres20.png}}
&
\subfloat[Vector $\chi$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures3D/sol_7_sur12sph_rayres20.png}}
&
\subfloat[Vector $\chi$]{\includegraphics[width=0.2\linewidth,height=2.5cm]{../Figures3D/sol_7_sur1cylsph_ray_sphres20.png}}
\\
\hline
\end{tabular}
\end{center}
...
\end{figure}
\end{comment}
%%% --------------------------- FEM solutions not computed yet --------------------------- %%%
