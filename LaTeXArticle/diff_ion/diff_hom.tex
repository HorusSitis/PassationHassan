...
Algorithms are the same as in the two-dimensional case, but we will see that CPU times is much bigger, %
...
\begin{tabular}{|c|c|c|c|}
\hline
\subfloat[Mesh around the inclusion]{\includegraphics[width=0.24\linewidth,height=2.55cm]{../Figures3D/maillage_mshSc035.png}}
...
\end{tabular}
\end{center}
\caption{Two-dimensional case : \dots}
\label{mesh_sol_2d}
\end{figure}
\end{comment}
